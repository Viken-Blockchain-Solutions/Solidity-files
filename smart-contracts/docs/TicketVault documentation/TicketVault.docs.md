---
description: TicketVault - Erc20 SingleStaking with rewards distribution
---
...
* [Introduction](../TicketVault%20documentation/TicketVault\_docs.md#introduction)
* [How-To](../TicketVault%20documentation/TicketVault\_docs.md#how-to)
* [Smart-contract](../TicketVault%20documentation/TicketVault\_docs.md#smart-contract)
  * [TicketVault Code](../TicketVault%20documentation/TicketVault\_docs.md#ticketvault-code-description)
    * [Constructor](../TicketVault%20documentation/TicketVault\_docs.md#constructor)
    * [Enum Status description](../TicketVault%20documentation/TicketVault\_docs.md#enum-status-description)
    * [Structs](TicketVault.docs.md#structs)
    * [Custom errors](../TicketVault%20documentation/TicketVault\_docs.md#custom-errors)
    * [Methods](TicketVault.docs.md#methods)
      * [Public methods](../TicketVault%20documentation/TicketVault\_docs.md#public-methods)
      * [Restricted methods](../TicketVault%20documentation/TicketVault\_docs.md#restricted-methods)
      * [Private methods](../TicketVault%20documentation/TicketVault\_docs.md#private-methods)
...
* [Step-by-Step tutorial](../TicketVault%20documentation/TicketVault\_docs.md#step-by-step-tutorial)
...
![Constructor screenshot](../TicketVault\_constructor.png)
...
*   With these variables set in the contract code, we can now deploy the TicketVault to the network of your choice.
    ...
    * Open [1\_deploy\_contracts.js](../../../scripts/1\_deploy\_contracts.js), at line 8, change `CONTRACT_ADDRESS` with the ERC20 contract address you want to use.
    * In your terminal, go to the folder, `../smart_contracts` and enter the code below to deploy the TicketVault smart contract.
...
* **VaultInfo**
  ...
  * `stakingPeriod`
    * The length of the stalking period in seconds.
  * `startTimestamp`
...
* **RewardInfo**
  ...
  * `pendingVaultRewards`
    * The accumulated rewards, pending ready to be released.
  * `claimedVaultRewards`
    * The rewards amount claimed.
  * `remainingVaultRewards`
    * The rewards amount that remains in the vault.
...
* **State changing methods/ transactions.**
  ...
  * `exitWhileCollecting()`.
    ...
    * Allows a stakeholder to withdraw their staked amount.
      ...
      * The remaining `withdrawAmount` is transferred to the stakeholders' account.
  * `exitWhileStaking()`.
    * Requires status `Staking`.
    * Allows a stakeholder to exit their staked position.
      * During `withdrawPenaltyPeriod`all rewards are locked in the vault.
      * A `withdrawFee` is calculated from, `withdrawAmount`then paid to the fee address.
      * The remaining `withdrawAmount` is sent to the stakeholder account.
  * `withdraw()`.
    * Requires status `Completed`.
    * Allows a stakeholder to withdraw their stake, and accumulated rewards, without any, withdrawal fee.
    * Emits the event `Withdraw(address indexed User, uint256 amount, uint256 rewards)` to the network.

#### **Restricted methods**

_Only owner restricted methods (Only the owner address can call these methods)._

* `setFeeAddress(address newFeeAddress)`.
  * Assign a new account to receive the withdrawal fees.
